...
ASSUMPTIONS_ANALYZER_MODEL=$(gsd-sdk query resolve-model gsd-assumptions-analyzer --pick model 2>/dev/null || echo "")
```
...
```
Agent(subagent_type="gsd-assumptions-analyzer", model="{ASSUMPTIONS_ANALYZER_MODEL}", prompt="""
